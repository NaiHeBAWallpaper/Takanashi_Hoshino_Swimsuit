...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Dive into Summer.flac';
let bgmvolume = 0;
let bgm;
...
const CHARACTER = 'Hoshino_swimsuit';
...
const AUDIO_DETAIL = [
	...
	},
	{
		time: 22000,
		count: 2,
		startTimes: [600, 11000],
		dialog: {
			Japanese: [
				"涼しい日陰…心地良い海風…穏やかな波の音…",
				"いやぁ、ここに来られて良かった～最高だねぇ、まるで夢みたいな場所だー…"
			],
			English: [
			...
			Chinese: [
				"啊啊，凉快的树荫……宜人的海风……有节奏的海浪声……",
				"呀，能来这里真好~太棒了呢，简直就像梦里才有的地方……"
			]
		}
	},
	{
		...
		dialog: {
			Japanese: [
				"…先生もそんなとこにずっと立ってないで、横になってみたら？",
				"あんまり広くはないけど、どう？良い感じだよ～？"
			],
			English: [
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"別にいいのに…まあ、そういうところ嫌いじゃないけど。",
				"…えへへ。"
			],
			English: [
				"I don't mind though...",
				"So, I guess that's why I like you. ...Heeheehee."
			],
			Chinese: [
				"明明没关系的……嘛，这点也不讨厌就是了。",
				"……诶嘿嘿"
...
const HITBOX = {
	headpat: { xMin: 1370, xMax: 2300, yMin: -50, yMax: 570 },
	voiceline: { xMin: 500, xMax: 1800, yMin: 800, yMax: 1500 }
};
